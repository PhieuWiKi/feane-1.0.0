...
$sql="INSERT INTO `book`(`name`, `phone`, `mail`, `amount`, `date`) VALUES ('".$_POST['name']."','".$_POST['phone']."','".$_POST['mail']."',".$_POST['amount'].",'".$_POST['date']."')";
$conn->query($sql);
$conn->close();
        ...
        <div class="col-md-6">
          <div class="form_container">
            <form action="book.php" method="post">
              ...
              <div>
                <input type="email" class="form-control" required placeholder="Your Email" name="mail" />
              </div>
              <div>
                <select class="form-control nice-select wide " required name="amount">
